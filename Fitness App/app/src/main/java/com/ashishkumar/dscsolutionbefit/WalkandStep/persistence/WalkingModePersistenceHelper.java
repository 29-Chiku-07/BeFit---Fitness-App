...
public class WalkingModePersistenceHelper {
    ...
    public static final String BROADCAST_ACTION_WALKING_MODE_CHANGED = "com.ashishkumar.dscsolutionbefit.WALKING_MODE_CHANGED";
    public static final String BROADCAST_EXTRA_OLD_WALKING_MODE = "com.ashishkumar.dscsolutionbefit.EXTRA_OLD_WALKING_MODE";
    public static final String BROADCAST_EXTRA_NEW_WALKING_MODE = "com.ashishkumar.dscsolutionbefit.EXTRA_NEW_WALKING_MODE";
