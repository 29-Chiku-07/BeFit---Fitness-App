package com.ashishkumar.dscsolutionbefit.fragments
...
import com.ashishkumar.dscsolutionbefit.helpers.AlarmHelper
...
class BottomSheetFragment(val mCtx: Context) : BottomSheetDialogFragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (resultCode == Activity.RESULT_OK && requestCode == 999) {
            ...
            val uri = data!!.getParcelableExtra<Intent>(RingtoneManager.EXTRA_RINGTONE_PICKED_URI) as Uri
